...
export function UsersThreeIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
      <path fill="currentColor" d="M8 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zm0 1a3.5 3.5 0 1 1 0-7 3.5 3.5 0 0 1 0 7zM3.5 7a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm0 1a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5zm9-1a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm0 1a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5zM1 13.5A2.5 2.5 0 0 1 3.5 11h1.086a3.5 3.5 0 0 0 6.828 0H12.5A2.5 2.5 0 0 1 15 13.5v.5h-1v-.5A1.5 1.5 0 0 0 12.5 12h-9A1.5 1.5 0 0 0 2 13.5v.5H1v-.5z"/>
    </svg>
  );
}
...
export function UserIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
      <path fill="currentColor" d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm0 1a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm-5.5 5.5A2.5 2.5 0 0 1 5 12h6a2.5 2.5 0 0 1 2.5 2.5V15h-1v-.5A1.5 1.5 0 0 0 11 13H5a1.5 1.5 0 0 0-1.5 1.5V15h-1v-.5z"/>
    </svg>
  );
}
...
export function LockIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
      <path fill="currentColor" d="M8 1a3 3 0 0 0-3 3v2H4a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-1V4a3 3 0 0 0-3-3zm2 5V4a2 2 0 1 0-4 0v2h4zM4 7h8v7H4V7z"/>
    </svg>
  );
}
...
export function AirtableWordmark() {
  return (
...
export function QuestionIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
      <circle cx="8" cy="8" r="6" />
      <path d="M6 6.5c0-.8.6-1.5 1.5-1.5s1.5.7 1.5 1.5c0 1-1 1.5-1.5 2" strokeLinecap="round" />
